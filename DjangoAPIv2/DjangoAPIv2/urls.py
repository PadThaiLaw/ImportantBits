...
decision_resource = DecisionResource()
citation_resource = CitationResource()
paragraph_resource = ParagraphResource()

urlpatterns = [
    url(r'^admin/', admin.site.urls),
    url(r'^api/', include(decision_resource.urls)),
    url(r'^api/', include(citation_resource.urls)),
    url(r'^api/', include(paragraph_resource.urls)),
]
